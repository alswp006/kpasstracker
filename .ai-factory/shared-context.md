...
- 0013: [부가] S3 this month's records edit screen (/records) (files: src/pages/Records.tsx, src/pages/__tests__/Records.test.tsx)
- 0014: [부가] S5 past refund records (/history) (files: src/pages/History.tsx, src/pages/__tests__/History.test.tsx)
- 0015: Routing, settings guard, Provider, FloatingTabBar wiring (App.tsx) (files: src/App.tsx, src/components/RequireSettings.tsx, src/__tests__/App.test.tsx)
...
// src/components/RequireSettings.tsx
...
export function parseIn(text: string, 
